...
Ku = 802    # number of Legendre integration sample points
Kv = 400    # number of allocations is directly proportional to this
...
#=
# add some explicit test checks between the analytic and empirical versions
